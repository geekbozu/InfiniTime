...
extern "C" {
#endif
#define McuLog_fatal NRF_LOG_INFO
#if 1
...
void __attribute__((used)) __asan_report_store1(void *address) {__asan_ReportGenericError();}
void __attribute__((used)) __asan_report_store2(void *address) {__asan_ReportGenericError();}
...
void __attribute__((used)) *__asan_malloc(size_t size) {
...
void __attribute__((used)) McuASAN_Init(void) {
